...
int ClientHandler::performSslaccept(void)
{
    int ret;
    if (ssl == nullptr)
    {
...
int ClientHandler::performRead(void)
{
    printf("perform_read\n");
    if (ssl == nullptr)
    {
...
int ClientHandler::performWrite(int num)
{
...
int ClientHandler::performSslshutdown(void)
{
    int ret;
    if (ssl == nullptr)
    {
